    ...
    return (
        <>
            <div className="flex flex-col justify-between box-content p-6 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700 mt-4">
                <div>
                    <a href="#">
                        <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">{t('card_eco_energy.title')}</h5>
                    </a>
                    <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">{t('card_eco_energy.description')}</p>
                </div>
            ...
            <>
                <Transition  appear show={isOpen} as={Fragment}>
                    <Dialog
                        ...
                        onClose={toggleModal}
                    >
                        <div className="fixed inset-0 min-h-screen px-4 text-center">
                            <Transition.Child
                                as={Fragment}
                            ...
                            >
                                ...
                                <div className="inline-block w-full max-w-3xl border-b-4 border-[#B72b35] my-8 overflow-hidden text-left align-middle transition-all transform bg-white shadow-lg rounded-lg z-50">
                                    ...
                                    >
                                        {t('card_eco_energy.energy_modal.title')}
                                    </Dialog.Title>

                                    <div className="relative p-6 flex-auto">
                                        <p className="my-4 text-slate-500 text-lg leading-relaxed">
                                            {t('card_eco_energy.energy_modal.description')}
                                        </p>
